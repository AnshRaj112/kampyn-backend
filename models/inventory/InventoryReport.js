    ...
    itemReceived: [
      {
        ...
        quantity: Number,
        source: { type: String, enum: ["produced", "received"], default: "received" },
        sourceVendorId: { type: mongoose.Schema.Types.ObjectId, ref: "Vendor" },
        sourceVendorName: { type: String },
    ...
    itemSend: [
      {
        ...
        kind: { type: String, enum: ["Retail", "Produce", "Raw"] },
        quantity: Number,
        targetVendorId: { type: mongoose.Schema.Types.ObjectId, ref: "Vendor" },
